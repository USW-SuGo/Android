...
class ProductUserPagingDataSource(
    private val apiService: SugoRetrofit,private val userId:Long
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, DealProduct> {
        ...
        return try {
            val Products = apiService.getUserCompletePageProduct(userId,position, 10)
            LoadResult.Page(
                data = Products,
